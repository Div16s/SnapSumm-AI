    ...
    return (
        <div className="text-center py-12">
            <div className="flex flex-col items-center gap-4">
                ...
                <Link href={"/upload"}>
                    <Button variant="link" className="mt-4 text-white bg-linear-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-600 hover:scale-105 font-bold transition-all duration-300">
